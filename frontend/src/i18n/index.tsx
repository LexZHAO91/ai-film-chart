...
const translations: Record<Lang, Record<string, string>> = {
  ...
  es: {
    ...
    'ranking.by': 'por',
    'ranking.min': 'min',
    'ranking.views': 'vistas',
    'ranking.likes': 'me gusta',
    'ranking.rating': 'calificación',
  ...
  ar: {
    ...
    'ranking.by': 'بواسطة',
    'ranking.min': 'دقيقة',
    'ranking.views': 'مشاهدات',
    'ranking.likes': 'إعجابات',
    'ranking.rating': 'تقييم',
